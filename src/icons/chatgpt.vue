<template>
  <div class="ly-icon-chatgpt">
    ...
    >
      <defs>
        <path id="black-bot_svg__a" d="M0 0h30v30H0z"></path>
        <path id="black-bot_svg__c" d="M0 0h20.455v20.455H0z"></path>
      </defs>
      <g>
        <mask id="black-bot_svg__b" fill="#fff">
          <use xlink:href="#black-bot_svg__a"></use>
        </mask>
        <g mask="url(#black-bot_svg__b)">
          <g transform="translate(4.773 4.773)">
            <mask id="black-bot_svg__d" fill="#fff">
              <use xlink:href="#black-bot_svg__c"></use>
            </mask>
            <g mask="url(#black-bot_svg__d)">
              <path
                fill-rule="evenodd"
